...
export default function VendreUnProduit() {
  ...
  const onSubmit = (data) => {
    ...
    // je veux envoyer l'image
    // body.append("image", data["Ajouter une image du produit"][0]);
    body.append("image", {
      uri: data["Ajouter une image du produit"][0],
      type: "image/jpeg",
      name: data["Ajouter une image du produit"][0].name,
    });
    console.log(data["Ajouter une image du produit"][0]);
...
const fields = [
  ...
  {
    type: "File",
    name: "Ajouter une image du produit",
    defaultValue: "",
    required: false,
  },
];
