...
const products = Array.from({ length: 8 }, (v, i) => ({
  id: i + 1,
  name: "Diay ma",
  image: "/images/banane.jpg",
  description: "cette banane est tres bonne",
  price: "680",   
}));
...
export default function Rappels() {
    ...
    const {responseAxios, error, loading, fetchData } = useAxios({
        url : 'http://localhost:8001/api/produitRappels',
        method : "GET",
        // body : null,
        headers : {
            ...
            <div className='bg-white rounded-t-md rounded-b-md shadow-xs p-4 '>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4">
                    ...
                    .map((product, index) => (
                        ...
                        //         <div class="mt-8">
                        //             <h4 class="font-bold text-xm">Exercises</h4>
                        //             <p class="mt-2 text-xm text-gray-600">Create Exercises for any subject with
                        //             </p>
                        ...
                        // </div>
                        <div key={index}
                            className={`w-[270px] border bg-white gap-1  min-h-[200px] p-2 flex flex-col rounded-2xl hover:-translate-y-2 hover:shadow-md transition-all cursor-pointer `}
                            >
                            {/* Product Image */}
                            ...
                            <div className=" flex flex-col">
                                ...
                                <p className="text-jay_primary text-xs py-2">{product.description}</p>
                            ...
                            <Button
                                ...
                                customStyle={"text-xm  rounded-lg"}
                            />
                            </div>
                        ...
                        //             <a>
                        //                 <img className="w-52" src="/images/banane.jpg" alt="src/assets/images/banane.jpg"/>
                        ...
                        //                         <svg className="-translate-y-px text-primary" width="14" height="14" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        //     </div>
                        // </div>
                        // <ProductCard price={product.price} key={index} title={product.libelle} description={product.description}  /> 
                    ))}
