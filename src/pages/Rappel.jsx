...
export default function Rappels() {
  const { responseAxios, error, loading, fetchData } = useAxios({
    url: "http://localhost:8000/api/produitRappels",
    method: "GET",
    // body : null,
    headers: {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white rounded-t-md rounded-b-md shadow-xs p-4 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 place-content-center lg:grid-cols-4 xl:grid-cols-4 gap-4 sm:gap-2 md:gap-4 lg:gap-6">
          {products
            ...
            .map((product, index) => (
              ...
              >
                ...
                <div className=" flex flex-col">
                  ...
                  <p className="text-jay_primary text-xs py-2">
                    {product.description}
                  </p>
