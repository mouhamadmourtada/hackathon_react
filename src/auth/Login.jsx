     ...
     >
       ...
       <section className="flex flex-col md:flex-row h-screen items-center">
            ...
            <div className="bg-indigo-600 hidden lg:block w-1/2 md:w-1/2 xl:w-1/2 h-screen">
                <img src="/images/registerImage.jpg" alt="" className="w-full h-full object-cover"/>
            </div>
            {/* formulaire et tout */}
            <div className="bg-white w-1/2 md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
                flex items-center justify-center">

                <div className="w-full h-100">


                    <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12 text-center text-primary">Se Connecter</h1>
                    ...
                    <form className="mt-6" >
                        ...
                        <div className="text-right mt-2">
                            <a href="#" className="text-sm font-semibold text-secondary hover:text-primary ">Mot de passe oublié?</a>
                        </div>

                        <button type="submit" onClick={handleLogin} className="transition ease-in-out w-full block bg-primary hover:bg-secondary hover:text-white hover:border-secondary text-accent font-semibold rounded-lg px-4 py-3 mt-6">
                            Se connecter
                        </button>
                    </form>
                    ...
                    <p className="mt-8">Besoin d'un compte ? <Link to="/register" className="text-secondary hover:text-primary font-semibold">Créer un compte !</Link></p>
