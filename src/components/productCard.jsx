...
export default function ProductCard({title,description,price,vendeur}) {
    return (
        <div className={`product w-[200px] border bg-white gap-1  min-h-[200px] p-2 flex flex-col rounded-2xl hover:-translate-y-2 hover:shadow-md transition-all cursor-pointer`}>
            {/* Product Image */}
            <div className="flex flex-col py-2 px-2 justify-between h-[180px] bg-[url('/images/imgfood.png')] bg-cover bg-center rounded-lg">
                    <div className="flex justify-between w-full ">
                        <span className="bg-white text-secondary px-2 h-fit rounded-md text-xs hover:scale-105 transition-all cursor-pointer">-</span>
